  ...
  <SafeAreaView style={{flex: 1}}>
    <ImageBackground
      ...
      <View style={styles.background2}>
        ...
        <TouchableOpacity
          style={styles.button}
          onPress={() => navigation.navigate('forder')}
          activeOpacity={0.5}>
          <Image
            style={[
              styles.image3,
            ...
            source={require('_assets/images/order-icon.png')}></Image>
          <Text style={[styles.text]}>My Orders</Text>
        </TouchableOpacity>

        <TouchableOpacity
          style={[styles.button, {left: wp(203)}]}
          onPress={() => navigation.navigate('farm')}
          activeOpacity={0.5}>
          <Image
            style={styles.image3}
            source={require('_assets/images/farm-icon.png')}></Image>
